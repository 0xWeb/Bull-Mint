                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_styles__WEBPACK_IMPORTED_MODULE_14__/* .Hero */ .VM, {
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                children: "Global Community of Certified Cryptocurrency Traders (CCT) ™ Creating a Future-Thinking Brand that Facilitates the Future Thinking of its Members Specializing in Change, Disruption, and Creativity Sending a Message."
                                            }),
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        children: [
            ...
            !isSoldOut && isActive && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("h3", {
                children: [
                    "Total estimated cost (Solana fees included): ",
                    totalSolCost,
                    " SOL",
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_material_ui_core_Dialog__WEBPACK_IMPORTED_MODULE_2___default()), {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_DialogTitle__WEBPACK_IMPORTED_MODULE_6___default()), {
                ...
                children: "Nfts you had just minted!"
            }),
...
const network = "mainnet-beta" || 0;
// const network = WalletAdapterNetwork.Devnet;
const rpcHost = "https://winter-muddy-firefly.solana-mainnet.quiknode.pro/c06f0ab7a4fbdf266dfe910743c27b91d6a2e9ee/" || 0;
const candyMachineId = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey("Fr7vTRH1Fm1ob5iKqMu1oN1Dge4KGr6s3BaV7JsxLF8p" || 0);
const defaultGuardGroup = process.env.NEXT_PUBLIC_DEFAULT_GUARD_GROUP || undefined; // undefined means default
...
const parseGuardStates = ({ guards , candyMachine , walletAddress , tokenHoldings , balance  })=>{
    ...
    if (typeof guards.redeemLimit == "number") {
        ...
        if (!canPayFor1) states.messages.push("Readeem limit has reached.");
    ...
    if (guards.payment?.sol) {
        ...
        if (!canPayFor2) states.messages.push("Don't have enough sol to pay");
    ...
    if (guards.payment?.token) {
        ...
        if (!canPayFor3) states.messages.push(`Don't have enough ${guards.payment?.token.symbol || "token"} to pay.`);
        states.canPayFor = Math.min(states.canPayFor, canPayFor3);
    }
    if (guards.payment?.nfts) {
        let canPayFor4 = guards.payment?.nfts.length || 0;
        if (!canPayFor4) states.messages.push(`Don't have enough nfts to pay.`);
    ...
    if (guards.gate?.token) {
        ...
        if (!canPayFor7) states.messages.push(`Don't have enough ${guards.gate?.token.symbol || "token"} to pass gate.`);
